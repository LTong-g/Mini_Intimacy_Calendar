...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      '黑名单的使用时间段通过独立入口查看；进入后可先选全部记录或某个应用，再查看对应记录；记录详情顶部汇总固定显示，下方记录可通过今日、7 天、30 天三个按钮切换范围，右侧筛选按钮可设置日期范围；全部记录详情还可在筛选弹窗中选择显示哪些黑名单应用；记录按日期分组并在日期右侧显示当日合计时长，全部记录详情中的每条记录会显示对应应用图标。',
