...
import { View, Text, TouchableOpacity, StyleSheet, Vibration, Alert, ToastAndroid, Platform, Dimensions } from 'react-native';
...
const CustomTabBar = ({ currentView, onViewChange, onCycleViews, selectedDate, onRefreshMonthView }) => {
    ...
    <View style={styles.container}>
      ...
      {showMoreMenu && (
        <View style={styles.moreMenu}>
          <TouchableOpacity style={styles.menuItem} onPress={() => {
            ...
            <Ionicons name="settings-outline" size={20} color="#333" style={{ marginRight: 6 }} />
      ...
      <CheckInButtons
        ...
        onCheckIn={async (type) => {
          ...
          const currentStatus = await require('../utils/checkInStorage').getCheckInStatus(selectedDate);
